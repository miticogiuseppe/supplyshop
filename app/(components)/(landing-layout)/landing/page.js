...
import { Landingaccordion, Landingtestimonials, Landingaccordion1 } from '../../../../shared/data/landing/landingdata';
        ...
        <Fragment>
                    ...
                    <div className="header-content-right">
                        ...
                        <div className="header-element align-items-center">
                            ...
                            <div className="btn-list d-lg-none d-flex">
                                <Link href="/authentication/sign-up/basic" className="btn btn-primary1-light">
                                    Sign Up
                                </Link>
                        ...
                        <nav className="main-menu-container nav nav-pills sub-open">
                            ...
                            <div className="d-lg-flex d-none">
                                <div className="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                                    <Link scroll={false} href="/authentication/sign-up/basic" className="btn btn-wave btn-primary1">
                                        Sign Up
                                    </Link>
            ...
            <div className="main-content landing-main px-0" onClick={handleClick1}>
                            ...
                            <Row className="pt-3">
                                <Col xxl={7} xl={7} lg={7} md={8}>
                                    <div className="pt-lg-5 pb-4">
                                        ...
                                        <Link href="/dashboard/sales" className="m-1 btn btn-lg bg-white-transparent">
                                            View Demos
                        ...
                        <Row>
                            <Col xl={4}>
                                <Spkimagecapcards Customclass="landing-card border shadow-none text-center" Custombodyclass="">
                                    ...
                                    <Link scroll={false} href="#!" className="fw-medium btn btn-sm btn-primary">Read More<i
                        ...
                        <div className="row gx-5 mx-0">
                            <Col xl={5}>
                                <div className="home-proving-image">
                                    <img src="../assets/images/media/landing/2.png" alt="" className="img-fluid] about-image d-none d-xl-block" />
                            ...
                            {servicecards.map((idx) => (
                                <Col xl={3} key={Math.random()}>
                                    ...
                                    <Card.Body className="text-center">
                                        ...
                                        <h6 className="fw-semibold">Responsive Design</h6>
                                        <p className="text-muted mb-0">Ensures the template is optimized for various screen sizes and devices, enhancing usability.</p>
                                    </Card.Body>
                                </Card> */}
                                </Col>
                            ))}
                            {/* <Col xl={3}>
                                <Card className="custom-card landing-card">
                                    <Card.Body className="text-center">
                                        ...
                                        <h6 className="fw-semibold">Pre-built Components</h6>
                                        <p className="text-muted mb-0">Ready-made UI components such as buttons, forms, tables, charts, and modals.</p>
                                    </Card.Body>
                                </Card>
                            </Col>
                            <Col xl={3}>
                                <Card className="custom-card landing-card">
                                    <Card.Body className="text-center">
                                        ...
                                        <h6 className="fw-semibold">Customization Options</h6>
                                        <p className="text-muted mb-0">Ability to customize colors, fonts, layouts, and other visual elements to match your brand.</p>
                                    </Card.Body>
                                </Card>
                            </Col>
                            <Col xl={3}>
                                <Card className="custom-card landing-card">
                                    <Card.Body className="text-center">
                                        ...
                                        <h6 className="fw-semibold">Documentation</h6>
                                        <p className="text-muted mb-0">Comprehensive documentation that guides you through installation, customization.</p>
                                    </Card.Body>
                                </Card>
                            </Col>
                            <Col xl={3}>
                                <Card className="custom-card landing-card">
                                    <Card.Body className="text-center">
                                        ...
                                        <p className="text-muted mb-0">Access to support forums, ticket systems, or direct support from the template provider.</p>
                                    </Card.Body>
                                </Card>
                            </Col>
                            <Col xl={3}>
                                <Card className="custom-card landing-card">
                                    <Card.Body className="text-center">
                                        ...
                                        <h6 className="fw-semibold">Updates and Maintenance</h6>
                                        <p className="text-muted mb-0">Regular updates to ensure compatibility with the latest web technologies and bug fixes.</p>
                                    </Card.Body>
                                </Card>
                            </Col>
                            <Col xl={3}>
                                <Card className="custom-card landing-card">
                                    <Card.Body className="text-center">
                                        <div className="mb-4">
                                            <div className="p-2 border d-inline-block border-warning border-opacity-10 bg-warning-transparent rounded-pill">
                                                <span className="avatar avatar-lg avatar-rounded bg-warning svg-white">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M224,200h-8V40a8,8,0,0,0-8-8H152a8,8,0,0,0-8,8V80H96a8,8,0,0,0-8,8v40H48a8,8,0,0,0-8,8v64H32a8,8,0,0,0,0,16H224a8,8,0,0,0,0-16ZM160,48h40V200H160ZM104,96h40V200H104ZM56,144H88v56H56Z"></path></svg>
                                                </span>
                                            </div>
                                        </div>
                                        <h6 className="fw-semibold">Multiple Layout</h6>
                                        <p className="text-muted mb-0">Different layout styles (sidebar navigation, top navigation) to suit different types of applications.</p>
                                    </Card.Body>
                                </Card>
                            </Col>
                            <Col xl={3}>
                                <Card className="custom-card landing-card">
                                    <Card.Body className="text-center">
                                        <div className="mb-4">
                                            <div className="p-2 border d-inline-block border-success border-opacity-10 bg-success-transparent rounded-pill">
                                                <span className="avatar avatar-lg avatar-rounded bg-success svg-white">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M224,200h-8V40a8,8,0,0,0-8-8H152a8,8,0,0,0-8,8V80H96a8,8,0,0,0-8,8v40H48a8,8,0,0,0-8,8v64H32a8,8,0,0,0,0,16H224a8,8,0,0,0,0-16ZM160,48h40V200H160ZM104,96h40V200H104ZM56,144H88v56H56Z"></path></svg>
                                                </span>
                                            </div>
                                        </div>
                                        <h6 className="fw-semibold">Performance Optimization</h6>
                                        <p className="text-muted mb-0">Code optimized for performance, including lazy loading of assets, CSS and JS files.</p>
                                    </Card.Body>
                                </Card>
                            </Col> */}
                        </Row>
                    ...
                    <div className="container">
                        ...
                        <Row>
                            <Col xl={3} lg={3} md={6} sm={6} className="col-12">
                                <SpkTeamcards Navigate="#!" Role="Director" Title="Hadley Kylin" Imgsrc="../assets/images/faces/1.jpg" Color="primary" CustomBodyclass="p-4" Imageclass="mb-4" Iconclass="mt-4" />
                            </Col>
                            <Col xl={3} lg={3} md={6} sm={6} className="col-12">
                                <SpkTeamcards Navigate="#!" Role="Board Director" Title="Owen Foster" Imgsrc="../assets/images/faces/8.jpg" Color="primary1" CustomBodyclass="p-4" Imageclass="mb-4" Iconclass="mt-4" />
                            </Col>
                            <Col xl={3} lg={3} md={6} sm={6} className="col-12">
                                <SpkTeamcards Navigate="#!" Role="Creative Director" Title="Stephen Roy" Imgsrc="../assets/images/faces/11.jpg" Color="primary2" CustomBodyclass="p-4" Imageclass="mb-4" Iconclass="mt-4" />
                            </Col>
                            <Col xl={3} lg={3} md={6} sm={6} className="col-12">
                                <SpkTeamcards Navigate="#!" Role="Board Director" Title="Jasmine Della" Imgsrc="../assets/images/faces/4.jpg" Color="primary3" CustomBodyclass="p-4" Imageclass="mb-4" Iconclass="mt-4" />
                            </Col>
                        </Row>
                    </div>
                </section>
                                    ...
                                    <div className="row d-flex align-items-center justify-content-center mb-5">
                                        {pricingsdata.map((idx) => (
                                            <Col lg={8} xl={4} xxl={4} md={8} sm={12} className="" key={Math.random()}>
                                                {/* <SpkPricingcards Title={idx.Title}
                                        landing={true}
                                        Customclass={idx.Customclass}
                                        Mainclass={idx.Mainclass}
                                        Customfooterclass={idx.footerClass}
                                        Customh6class={idx.Customh6class}
                                        Customh2class={idx.Customh2class}
                                        Custombodyclass={idx.Custombodyclass}
                                        descriptionclass={idx.descriptionclass}
                                        color={idx.buttonClass}
                                        price={idx.price}
                                        pricingPlan={idx.pricingPlan}
                                        description={idx.description}
                                        arrowClass={idx.arrowClass}
                                        listItems={idx.features.map(feature => ({
                                            Listitem: feature.Listitem,
                                            badge: feature.badge ? feature.badge : undefined, 
                    ...
                    <div className="container">
                        <Row>
                            <div className="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
                                <div className="px-4">
                                    <p className="fw-medium mb-3"><Link scroll={false} href="/dashboard/sales"><img
                                        src="../assets/images/brand-logos/desktop-dark.png" alt="" className="landing-footer-logo" /></Link></p>
                            ...
                            <div className="col-md-2 col-sm-6 col-12">
                                <div className="px-4">
                                    ...
                                    <ul className="list-unstyled op-6 fw-normal landing-footer-list">
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Email</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Profile</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Timeline</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Projects</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Contacts</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Portfolio</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-md-2 col-sm-6 col-12">
                                <div className="px-4">
                                    ...
                                    <ul className="list-unstyled op-6 fw-normal landing-footer-list">
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Our Team</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Contact US</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">About</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Services</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Blog</Link>
                                        </li>
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white">Terms & Conditions</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-md-4 col-sm-6 col-12">
                                <div className="px-4">
                                    ...
                                    <ul className="list-unstyled fw-normal landing-footer-list">
                                        <li>
                                            <Link scroll={false} href="#!" className="text-fixed-white op-6"><i
                ...
                <div className="text-center landing-main-footer py-3">
                    <span className="text-muted fs-15"> Copyright © <span id="year"> 2024 </span> <Link scroll={false} href="#!"
                        className="text-primary fw-medium"><u>Xintra</u></Link>.
                        Designed with <span className="fa fa-heart text-danger"></span> by <Link scroll={false} href="#!"
