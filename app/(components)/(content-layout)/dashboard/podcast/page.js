                            ...
                            <div className="list-unstyled podcast-recently-played-list row">
                                <div className="col-xl-3 col-sm-6 mb-3 mb-xl-0">
                                    <div className="bg-light align-items-center gap-2 p-3 text-center rounded">
                                        ...
                                        <div>
                                            <Link scroll={false} href="#!" className="fw-semibold">Technos Talk</Link>
                                ...
                                <Col xl={3} sm={6}>
                                    <div className="bg-light align-items-center gap-2 p-3 text-center rounded">
                                        ...
                                        <div>
                                            <Link scroll={false} href="#!" className="fw-semibold">Science Explorers</Link>
                                ...
                                <div className="col-xl-3 col-sm-6 mb-3 mb-xl-0">
                                    <div className="bg-light align-items-center gap-2 p-3 text-center rounded">
                                        ...
                                        <div>
                                            <Link scroll={false} href="#!" className="fw-semibold">Business Insights</Link>
                                ...
                                <Col xl={3} sm={6}>
                                    <div className="bg-light align-items-center gap-2 p-3 text-center rounded">
                                        ...
                                        <div>
                                            <Link scroll={false} href="#!" className="fw-semibold">Entertainment</Link>
                                    ...
                                    <div className="d-flex align-items-center p-3 bg-light flex-wrap gap-2 flex-sm-nowrap mb-3 mb-xl-0">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex align-items-start justify-content-between mb-4 flex-wrap">
                                                <div>
                                                    <Link scroll={false} href="#!"><h6 className="fw-semibold mb-0">Foodie Adventures</h6></Link>
                                ...
                                <div className="col-xl-4">
                                    <div className="d-flex align-items-center p-3 bg-light flex-wrap gap-2 flex-sm-nowrap mb-3 mb-xl-0">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex align-items-start justify-content-between mb-4 flex-wrap">
                                                <div>
                                                    <Link scroll={false} href="#!"><h6 className="fw-semibold mb-0"> Environmental Insights</h6></Link>
                                ...
                                <div className="col-xl-4">
                                    <div className="d-flex align-items-center p-3 bg-light flex-wrap gap-2 flex-sm-nowrap mb-3 mb-xl-0">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex align-items-start justify-content-between mb-4 flex-wrap">
                                                <div>
                                                    <Link scroll={false} href="#!"><h6 className="fw-semibold mb-0">Travel Tales</h6></Link>
                                ...
                                <div className="col-xl-4">
                                    <div className="d-flex align-items-center p-3 bg-light flex-wrap gap-2 flex-sm-nowrap mb-3 mb-xl-0">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex align-items-start justify-content-between mb-4 flex-wrap">
                                                <div>
                                                    <Link scroll={false} href="#!"><h6 className="fw-semibold mb-0">True Crime Files</h6></Link>
                                ...
                                <div className="col-xl-4">
                                    <div className="d-flex align-items-center p-3 bg-light flex-wrap gap-2 flex-sm-nowrap mb-3 mb-xl-0">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex align-items-start justify-content-between mb-4 flex-wrap">
                                                <div>
                                                    <Link scroll={false} href="#!"><h6 className="fw-semibold mb-0">Science Explained</h6></Link>
                                ...
                                <div className="col-xl-4">
                                    <div className="d-flex align-items-center p-3 bg-light flex-wrap gap-2 flex-sm-nowrap mb-3 mb-xl-0">
                                        ...
                                        <div className="w-100">
                                            <div className="d-flex align-items-start justify-content-between mb-4 flex-wrap">
                                                <div>
                                                    <Link scroll={false} href="#!"><h6 className="fw-semibold mb-0">Business Buzz</h6></Link>
                        ...
                        <Card.Body className=" p-4">
                            <div className="text-center mb-4">
                                <span className="mb-3 podcast-playing-now">
                                    <img src="../../assets/images/podcast/1.jpg" alt="" className="w-100 rounded-circle shadow-sm" />
                                </span>
                            ...
                            <div className="d-flex gap-3 align-items-center mb-4 pb-4">
                                ...
                                <SpkProgress mainClass="progress progress-xs progress-custom podcast-playing-progress" animated={true} aria-valuenow={50} aria-valuemin={0} aria-valuemax={100} bg="primary" now={50} />
                                        ...
                                        <tr key={Math.random()}>
                                            <td>
                                                <div className="d-flex gap-2">
                                                    ...
                                                    <div>
                                                        <Link scroll={false} href="#!" className="fw-semibold mb-0 d-flex align-items-center">{idx.podcast}</Link>
