...
import { Attoptions, Attseries, EventData, Examresult, SchoolCrad, Schoolactivity, Startdata, Stuoptions, Stuseries, Teacherdata } from "../../../../../shared/data/dashboard/schoolsdata";
            ...
            <Row>
                <Col xl={7}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className="">
                            <div className="d-flex gap-5 mb-3 align-items-center justify-content-center flex-wrap flex-xl-nowrap">
                ...
                <Col xl={5}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <Link scroll={false} href="#!" className="btn btn-sm bg-light text-default"> View All<i className="ti ti-arrow-narrow-right ms-1"></i> </Link>
                        </Card.Header>
                ...
                <Col xxl={4}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <Link scroll={false} href="#!" className="fs-12 text-muted btn btn-sm btn-light"> View All<i className="ti ti-arrow-narrow-right ms-1"></i> </Link>
                        </Card.Header>
                        <Card.Body className=" p-0">
                            <div className="table-responsive">
                                <SpkTablescomponent>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-3">
                                                    ...
                                                    <div className="flex-fill">
                                                        <div>
                                                            <div className="fw-medium d-block my-1 fs-14" dangerouslySetInnerHTML={{ __html: event.title }}></div>
                        ...
                        <div className="card-footer p-0">
                            <div className="row mt-0">
                                ...
                                <div className="col-6 text-center p-3">
                                    ...
                                    <h5 className="text-secondary fw-medium">10.19K</h5>
                                </div>
                            </div>
                        </div>
                    </Card>
                ...
                <Col xxl={4}>
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <Link scroll={false} href="#!" className="btn btn-sm bg-light text-muted"> View All<i className="ti ti-arrow-narrow-right ms-1"></i> </Link>
                        </Card.Header>
                        <Card.Body className="">
