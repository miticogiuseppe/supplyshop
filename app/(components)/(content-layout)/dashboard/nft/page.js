...
import SpkCardNft from "../../../../../shared/@spk-reusable-components/reusable-dashboards/spk-cardnft";
                        ...
                        <Card.Body className="p-4">
                            <div className="row align-items-center mx-0">
                                ...
                                <Col xl={5} className="text-end">
                                    <img src="../../assets/images/nft-images/1.jpg" className="img-fluid nft-main-banner-image shadow p-3 me-2" alt="" />
                                </Col>
                            </div>
                        </Card.Body>
                    </Card>
                        ...
                        <Card.Body className="bg-light m-2 rounded-1">
                            <div className="d-flex flex-wrap align-items-center gap-3 flex-xl-nowrap">
                                ...
                                <div className="ms-auto">
                                    <Link scroll={false} href="#!" className="btn btn-primary-gradient">View Transactions</Link>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
                                    ...
                                    <li className="list-group-item d-flex gap-1" key={Math.random()}>
                                        ...
                                        <div className="ms-auto my-auto">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <Link scroll={false} href="#!" className="btn btn-primary-light btn-sm "><i className="ri-add-line align-middle me-1"></i>Follow</Link>
                                            </div>
                                        </div>
                                    </li>
                                ))}
                                        ...
                                        <tr key={Math.random()}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <p className="mb-0 fw-semibold"><Link scroll={false} href="#!" title="nft_name">{idx.collection}</Link></p>
                                                        <Link scroll={false} href="#!" className="fs-12 text-muted fw-normal" title="creator_name">{idx.mail}</Link>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span className={`text-${idx.color}`}><i className={`ti ti-trending-${idx.icon} me-1 align-middle d-inline-block`}></i>{idx.data}%</span>
                                            </td>
                                            <td>{idx.owners}</td>
                                            <td><span className={`text-${idx.color1}`}><i className={`ti ti-trending-${idx.icon1} me-1 align-middle d-inline-block`}></i>{idx.data1}%</span></td>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <div className="me-2 lh-1">
                                                        <span className="avatar avatar-xs avatar-rounded">
                                                    ...
                                                    <div>
                                                        <p className="mb-0 fw-semibold"><Link scroll={false} href="#!" title="nft_name">{idx.price}</Link></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{idx.item}</td>
