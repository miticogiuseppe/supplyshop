...
import Spksocialmediacardscomponent from "../../../../../shared/@spk-reusable-components/reusable-dashboards/spk-socialmediacard";
                            ...
                            <div className="row p-3 gx-3 align-items-center">
                                <div className="col-xl-6 px-0">
                                    <div id="follow-on-device">
                                        <Spkapexcharts chartOptions={Deviceoptions} chartSeries={Deviceseries} type="donut" width={"100%"} height={167} />
                                    </div>
                                </div>
                                <Col xl={6}>
