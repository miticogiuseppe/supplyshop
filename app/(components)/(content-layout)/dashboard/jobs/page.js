...
import { Acceptoptions, Acceptseries, Activedata, Hiredata, Jobscard, Jobsoptions, Jobsseries, ReJobs, Recentdata } from "../../../../../shared/data/dashboard/jobsdata";
            ...
            <Row className="row-cols row-cols-xl-5">
                {Jobscard.map((idx) => (
                    <Col xl={6} className="col-xxl" key={Math.random()}>
                        <Spkcardscomponent parentClass="flex-fill" dataClass="mb-1" mainClass="d-flex gap-3 align-items-center" headingClass="d-block mb-2" card={idx} badgeClass={`lg svg-${idx.badgeColor} avatar-rounded border-3 border border-opacity-50 flex-shrink-0 border-${idx.badgeColor}`} svgIcon={idx.svgIcon} />
                    </Col>
                ))}
            </Row>
            {/* <!--End::row-1 --> */}
                                    ...
                                    <li key={Math.random()} className={idx.class}>
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-fill text-truncate">
                                                <Link scroll={false} href="#!" className="fw-medium fs-14 w-75 text-truncate d-block"> {idx.data1}</Link>
                ...
                <Col xxl={3} md={12}>
                    <Card className="custom-card">
                        <div className="card-header justify-content-between">
                            ...
                            <SpkDropdown toggleas="a" Customtoggleclass="btn btn-outline-light border btn-full btn-sm no-caret" Navigate="#!" Icon={true} Toggletext="View All" IconClass="ti ti-chevron-down ms-1 mx-1">
                            ...
                            <ul className="mb-0 list-unstyled">
                                <li className="mb-4">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <Link scroll={false} href="#!" className="fs-13 fw-medium"> Mona Cruzis</Link>
                                        ...
                                        <div className="btn-list">
                                            <SpkTooltips placement="top" title="Call">
                                                <Link scroll={false} href="#!" className="btn btn-icon btn-sm rounded-pill btn-info-light"><i className="ti ti-phone align-middle"></i></Link>
                                            </SpkTooltips>
                                            <SpkTooltips placement="top" title="Mail">
                                                <Link scroll={false} href="#!" className="btn btn-icon btn-sm rounded-pill btn-primary1-light"><i className="ti ti-at align-middle"></i></Link>
                                            </SpkTooltips>
                                        </div>
                                    </div>
                                </li>
                                <li className="mb-4">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <Link scroll={false} href="#!" className="fs-13 fw-medium"> Soyab Khan</Link>
                                ...
                                <li className="mb-4">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <Link scroll={false} href="#!" className="fs-13 fw-medium"> Katherine Myn </Link>
                                ...
                                <li className="mb-4">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <Link scroll={false} href="#!" className="fs-13 fw-medium"> James Roy</Link>
                                            <p className="text-muted mb-0 fw-normal fs-12"><span className="fw-medium">React Developer</span></p>
                                        </div>
                                        <div className="btn-list">
                                            <SpkTooltips placement="top" title="Call">
                                ...
                                <li className="mb-4">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <Link scroll={false} href="#!" className="fs-13 fw-medium"> Cayathe Dore </Link>
                                ...
                                <li className="mb-1">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            <Link scroll={false} href="#!" className="fs-13 fw-medium"> Surjith Pandey</Link>
                                ...
                                <SpkTablescomponent tableClass="text-nowrap recent-job" header={[{ title: 'Job Title' }, { title: 'Applicants' }, { title: 'Openings End' }, { title: 'Location' }, { title: 'Action' }]}>
                                    {ReJobs.map((idx) => (
                                        <tr key={Math.random()}>
                                            ...
                                            <td>
                                                <div className="btn-list">
                                                    <Link scroll={false} href="#!" className="btn btn-icon btn-sm btn-primary-light"><i className="ti ti-edit"></i></Link>
                                                    <Link scroll={false} href="#!" className="btn btn-icon btn-sm btn-primary1-light"><i className="ti ti-trash"></i></Link>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
                                        ...
                                        <tr key={Math.random()}>
                                            ...
                                            <td>
                                                <div className="hstack gap-2 fs-15">
                                                    <Link scroll={false} aria-label="anchor" href="#!" className="btn btn-icon btn-sm btn-success-light"><i className="ri-download-2-line"></i></Link>
                                                    <Link scroll={false} aria-label="anchor" href="#!" className="btn btn-icon btn-sm btn-primary-light"><i className="ri-edit-line"></i></Link>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
