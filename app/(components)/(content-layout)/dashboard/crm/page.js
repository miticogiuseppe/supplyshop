            ...
            <Row>
                {Crmcard.map((idx) => (
                    <Col md={6} lg={4} className="col-xl" key={Math.random()}>
                        <SpkCrmcard cardClass="crm-card" color={idx.borderColorClass} color1={idx.color} title={idx.title} price={idx.price} percent={idx.percent} svgIcon={idx.icon} dir={idx.dir}/>
                    </Col>
                ))}
            </Row>
            {/* <!-- End::row-1 --> */}
                ...
                <Col md={12} xxl={3} className="">
                    <Card className="custom-card overflow-hidden earnings-card card-bg-primary shadow-sm">
                        <Card.Body className="p-0 text-fixed-white">
                            ...
                            <div id="profit-report"><Spkapexcharts chartOptions={Profitoptions} chartSeries={Profitseries} type="area" width={"100%"} height={145} />
                            </div>
                        ...
                        <Card.Body>
                            <SpkListgroup as="ul" CustomClass="list-unstyled mb-0">
                                <ListGroup.Item as="li" className="border-0 p-0 mb-4">
                                    ...
                                    <SpkProgress mainClass="progress-xs mt-2 mb-0" variant="primary" striped={true} animated={true} now={80} aria-valuenow={80} aria-valuemin={0} aria-valuemax={100} />
                                </ListGroup.Item>
                                <ListGroup.Item as="li" className="border-0 p-0 mb-4">
                                    <div className="d-flex justify-content-between align-items-top">
                                        <div className="d-flex">
                                                            ...
                                                            <div className="d-flex align-items-start justify-content-between gap-1 flex-wrap">
                                                                ...
                                                                <div className="d-flex gap-1">
                                                                    <SpkTooltips placement="top" title="Edit">
                                                                        <Link scroll={false} href="#!" className="btn btn-sm btn-info-light btn-icon me-1">
                                                                            <i className="ti ti-edit"></i>
                                                                        </Link>
                                                                    </SpkTooltips>
                                                                    <SpkTooltips placement="top" title="Delete">
                                                                        <Link scroll={false} href="#!" className="btn btn-sm btn-danger-light btn-icon">
                                                    ...
                                                    <div className="todolist d-flex">
                                                        ...
                                                        <div className="flex-fill w-100">
                                                            <div className="d-flex align-items-start justify-content-between gap-1">
                                                                ...
                                                                <div className="d-flex gap-1">
                                                                    <SpkTooltips placement="top" title="Edit">
                                                                        <Link scroll={false} href="#!" className="btn btn-sm btn-info-light btn-icon">
                                                                            <i className="ti ti-edit"></i>
                                                                        </Link>
                                                                    </SpkTooltips>
                                                                    <SpkTooltips placement="top" title="Delete">
                ...
                <Col xxl={3}>
                    <Card className="custom-card overflow-hidden">
                        <div className="card-header justify-content-between">
                            ...
                            <SpkDropdown Customtoggleclass="btn btn-sm btn-light dropdown-toggle no-caret" Toggletext="Yearly" IconClass="ti ti-chevron-down ms-1" Icon={true}>
                                        ...
                                        <tr key={Math.random()}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <Link scroll={false} href="#!" className="fw-medium">{idx.repname}</Link>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{idx.close}</td>
                ...
                <Col xl={12}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <SpkDropdown Togglevariant="" toggleas="a" Customtoggleclass="btn btn-light border btn-full btn-sm no-caret" Toggletext="View All" IconClass="ti ti-chevron-down ms-1 mx-1" Icon={true}>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    ...
                                                    <div className="flex-1 ms-2">
                                                        ...
                                                        <Link scroll={false} href="#!" className="text-muted fs-12">{idx.mail}</Link>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="btn-list">
                                                    <SpkTooltips placement="top" title="View">
                                                        <Link href="#!" scroll={false} className="btn  btn-icon rounded-pill btn-primary-light"><i className="ti ti-eye"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Edit">
                                                        <Link href="#!" scroll={false} className="btn  btn-icon rounded-pill btn-info-light"><i className="ti ti-pencil"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Delete">
                                                        <Link href="#!" scroll={false} className="btn  btn-icon rounded-pill  btn-primary2-light"><i className="ti ti-trash"></i></Link>
                                                    </SpkTooltips>
                                                </div>
                                            </td>
                                        </tr>
