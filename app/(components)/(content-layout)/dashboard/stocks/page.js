...
import { Marketdata, Portoptions, Portseries, Srockdata, StockSlides, Stockareaoptions, Stockareaseries, Stockoptions, Stockseries, Transactiondata, Visioptions, Visiseries, Wishlistdata } from "../../../../../shared/data/dashboard/stocksdata";
                        ...
                        <Card.Body>
                            <div className="d-sm-flex align-items-end  p-3 bg-light gap-5 flex-wrap">
                                ...
                                <div className="flex-1 text-sm-end mt-2 mt-sm-0 ms-auto">
                                    <Link scroll={false} href="#!" className="btn btn-w-lg btn-primary1-light"><i className="ti ti-plus me-1"></i>Compare</Link>
                                </div>
                            </div>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-2">
                                                    <span className={`avatar avatar-md p-2 avatar-rounded border border-${idx.color} border-opacity-10 bg-${idx.color}-transparent`}>
                                                        <img src={idx.src} alt="" className="invert-1" />
                                                    </span>
                                                    <div>
                                                        <Link scroll={false} href="#!" className="fw-medium">{idx.head}</Link>
                                    ...
                                    {Srockdata.map((idx) => (
                                        <tr key={Math.random()}>
                                            ...
                                            <td className="btn-list">
                                                <Link scroll={false} href="#!" className="btn btn-sm btn-primary-light">Buy</Link>
                                                <Link scroll={false} href="#!" className="btn btn-sm btn-primary1-light">Sell</Link>
                                            </td>
                                        </tr>
                                    ))}
                                </SpkTablescomponent>
                                        ...
                                        <tr key={Math.random()}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <Link scroll={false} href="#!" className="fw-medium">{idx.stock}</Link>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{idx.shares}</td>
