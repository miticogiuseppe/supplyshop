...
import SpkProjectscardcomponent from "../../../../../shared/@spk-reusable-components/reusable-dashboards/spk-projectscard";
...
import { Projectdata, Runningavatar, Staticoptions, Staticseries, Targetoptions, Targetseries, Tasksoptions, Tasksseries, Teamdata, projects, statusColors } from "../../../../../shared/data/dashboard/projectsdata";
                ...
                <Col xxl={5}>
                        ...
                        <Card.Body className="p-4">
                            <div className="row justify-content-between">
                                <Col xxl={8} xl={5} lg={5} md={5} sm={5} className="">
                                    ...
                                    <Link scroll={false} href="#!" className="btn btn-sm btn-primary1">Manage Now<i className="ti ti-arrow-narrow-right"></i></Link>
                                </Col>
                    ...
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <Link scroll={false} href="#!" className="btn btn-sm btn-light">View All</Link>
                        </Card.Header>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    ...
                                                    <div className="flex-1 ms-2">
                                                        ...
                                                        <Link scroll={false} href="#!" className="text-muted fs-12">{idx.data}</Link>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="btn-list">
                                                    <SpkTooltips placement="top" title="Assign">
                                                        <Link scroll={false} href="#!" className="btn btn-icon btn-sm rounded-pill mb-0 btn-primary-light"><i className="ti ti-user-plus align-middle"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Mail">
                                                        <Link scroll={false} href="#!" className="btn btn-icon btn-sm rounded-pill mb-0 btn-info-light"><i className="ti ti-at align-middle"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="View">
                                                        <Link scroll={false} href="#!" className="btn btn-icon btn-sm rounded-pill mb-0 btn-primary2-light"><i className="ti ti-eye align-middle"></i></Link>
                                                    </SpkTooltips>
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        <div className="p-3 pb-2">
                            ...
                            <div>
                                <div className="progress progress-lg rounded-pill p-1 ms-auto bg-primary-transparent" role="progressbar" aria-valuenow={90} aria-valuemin={0} aria-valuemax={100}>
                                    <div className="progress-bar progress-bar-striped progress-bar-animated rounded-pill bg-primary"  style={{ width: "90%" }}></div>
                                </div>
                            </div>
                        </div>
                        <div className="p-3 pb-2">
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body className="">
                            <div id="monthly-target">
                                <Spkapexcharts chartOptions={Targetoptions} chartSeries={Targetseries} type="radialBar" width={"100%"} height={260} />
                            </div>
                                        ...
                                        <Card.Body className="">
                                            <p className="fw-medium mb-2 lh-1 d-flex align-items-center gap-2 justify-content-between">Home Page Design
                                                <SpkTooltips placement="top" title="View Details">
                                                    <Link scroll={false} aria-label="anchor" href="#!" className="float-end fs-16 text-primary "><i className="ri-add-circle-fill"></i></Link>
                                                </SpkTooltips>
                                            </p>
                                    ...
                                    <div className="card border border-primary1 border-opacity-25 shadow-none custom-card mb-0 bg-primary1-transparent">
                                        <Card.Body className="">
                                            <p className="fw-medium mb-2 lh-1 d-flex align-items-center gap-2 justify-content-between">Meeting Hour
                                                <SpkTooltips placement="top" title="View Details">
                                                    <Link scroll={false} aria-label="anchor" href="#!" className="float-end fs-16 text-primary1 "><i className="ri-add-circle-fill"></i></Link>
                                                </SpkTooltips>
                                            </p>
                                            <div className="d-flex flex-wrap gap-2 align-items-center">
                                                <SpkBadge variant="primary-transparent">Framework</SpkBadge>
                                    ...
                                    <div className="card border border-primary2 border-opacity-25 shadow-none custom-card mb-0 bg-primary2-transparent">
                                        <Card.Body className="">
                                            <p className="fw-medium mb-2 lh-1 d-flex align-items-center gap-2 justify-content-between">Projects Work Progress
                                                <SpkTooltips placement="top" title="View Details">
                                                    <Link scroll={false} aria-label="anchor" href="#!" className="float-end fs-16 text-primary2 "><i className="ri-add-circle-fill"></i></Link>
                                                </SpkTooltips>
                                            </p>
                                            <div className="d-flex flex-wrap gap-2 align-items-center">
                                                <SpkBadge variant="info-transparent">Php</SpkBadge>
                                    ...
                                    <div className="card border border-primary3 border-opacity-25 shadow-none custom-card mb-0 bg-primary3-transparent">
                                        <Card.Body className="">
                                            <p className="fw-medium mb-2 lh-1 d-flex align-items-center gap-2 justify-content-between">Status Updation by Team Leads
                                                <SpkTooltips placement="top" title="View Details">
                                                    <Link scroll={false} aria-label="anchor" href="#!" className="float-end fs-16 text-primary3 "><i className="ri-add-circle-fill"></i></Link>
                                                </SpkTooltips>
                                            </p>
                                            <div className="d-flex flex-wrap gap-2 align-items-center">
                                                <SpkBadge variant="primary-transparent">Framework</SpkBadge>
                                    ...
                                    {projects.map((project) => (
                                        <tr key={project.id}>
                                            ...
                                            <td>
                                                <div className="btn-list">
                                                    <SpkTooltips placement="top" title="View">
                                                        <Link scroll={false} aria-label="anchor" href="#!" className="btn btn-icon rounded-pill btn-sm btn-primary-light"><i className="ti ti-eye"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Edit">
                                                        <Link scroll={false} aria-label="anchor" href="#!" className="btn btn-icon rounded-pill btn-sm btn-secondary-light"><i className="ti ti-pencil"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Delete">
                                                        <Link scroll={false} aria-label="anchor" href="#!" className="btn btn-icon rounded-pill btn-sm btn-danger-light"><i className="ti ti-trash"></i></Link>
                                                    </SpkTooltips>
                                                </div>
                                            </td>
                                        </tr>
