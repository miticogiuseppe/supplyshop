...
import { Balanceoptions, Balanceseries, Coindata, CryptoSwiper, Cryptooptions, Cryptoseries, Currencydata, Marketdata, Profiledata, Transactiondata } from "../../../../../shared/data/dashboard/cryptodata";
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div className="d-flex flex-wrap p-3 bg-light rounded-2 mb-3 align-items-center">
                                <div className="me-3">
                                    <SpkDropdown as={ButtonGroup} Customclass="ms-2" Customtoggleclass="btn btn-primary border dropdown-toggle" Toggletext="Bitcoin" Imageclass=" avatar avatar-xs avatar-rounded mx-2 align-middle" Imagetag={true} Imagesrc="../../assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg">
                                        <Dropdown.Item as="li" href="#!"><span className="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="../../assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg" alt="" /></span>Etherium</Dropdown.Item>
                                        <Dropdown.Item as="li" href="#!"><span className="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="../../assets/images/crypto-currencies/crypto-icons/tether-usdt-logo.svg" alt="" /></span>Tether</Dropdown.Item>
                                        <Dropdown.Item as="li" href="#!"><span className="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="../../assets/images/crypto-currencies/crypto-icons/xrp-xrp-logo.svg" alt="" /></span>XRP</Dropdown.Item>
                                        <Dropdown.Item as="li" href="#!"><span className="avatar avatar-xs avatar-rounded me-2 align-middle"><img src="../../assets/images/crypto-currencies/crypto-icons/tron-trx-logo.svg" alt="" /></span>TRON</Dropdown.Item>
                                    </SpkDropdown>
                                </div>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            ...
                            <div className=" mt-2 pt-1 d-flex gap-1">
                                <SpkButton Buttonvariant="primary1-light" Buttontype="button" Customclass="flex-fill">History<i className="ms-2 ti ti-arrow-narrow-right align-middle mx-1"></i></SpkButton>
                                <SpkButton Buttonvariant="primary" Buttontype="button" Customclass="flex-fill">Convert<i className="ms-2 ti ti-arrow-narrow-right align-middle mx-1"></i></SpkButton>
                            </div>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className="col-xxl-3 col-xl-6">
                    <Card className="custom-card">
                        <div className="card-header justify-content-between">
                            ...
                            <Link scroll={false} href="#!" className="btn btn-light btn-wave btn-sm text-muted waves-effect waves-light">View All<i className="ti ti-arrow-narrow-right ms-1 mx-1"></i></Link>
                        </div>
                        <Card.Body>
                ...
                <Col xxl={5}>
                    <Card className="custom-card overflow-hidden">
                        <div className="card-header justify-content-between">
                            ...
                            <Link scroll={false} href="#!" className="text-muted text-decoration-underline link-offset-2">View All</Link>
                        </div>
                                    ...
                                    {Transactiondata.map((idx) => (
                                        <tr key={Math.random()}>
                                            <td>
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className={`avatar avatar-rounded avatar-md p-2 bg-${idx.avatarBg}`}>
                                                            <img src={idx.src} alt="" />
                                                        </span>
                                                    </div>
                                                    <div className="flex-fill">
