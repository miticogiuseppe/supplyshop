...
const Hrm = () => {
    ...
    const handleDelete = (index) => {
        const updatedData = employeeData.filter((_, i) => i !== index);
            ...
            <Row>
                {Hrmcard.map((idx) => (
                    <Col xxl={3} xl={6} key={Math.random()}>
                        <SpkHrmcard cardClass="overflow-hidden" chartOptions={idx.chartOptions} color={idx.color} chartSeries={idx.chartSeries} icon={idx.direction} price={idx.value} title={idx.title} percent={idx.percentage} data={idx.description} type="area" height={60} />
                    </Col>
                ))}
            </Row>
            {/* <!-- End:: row-1 --> */}
                ...
                <Col xxl={8}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className="pb-1">
                            <ul className="d-flex flex-wrap mb-0 list-unstyled gap-5 justify-content-around p-3 border rounded border-dashed">
                                <li>
                ...
                <Col xxl={4}>
                    <Card className="custom-card">
                        <div className="card-header justify-content-between">
                            ...
                            <Link aria-label="anchor" href="#!" className="btn btn-sm btn-primary-light">
                                View All
                            </Link>
                        </div>
                        <Card.Body className="">
                                ...
                                {Eventsdata.map((event) => (
                                    <li className="timeline-widget-list" key={event.id}>
                                        <div className="d-flex align-items-center flex-wrap">
                                            ...
                                            <div className="d-flex flex-wrap flex-fill align-items-top justify-content-between flex-xl-nowrap">
                ...
                <Col xxl={5}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <Link href="#!" scroll={false} className="btn btn-sm btn-light">View All</Link>
                        </Card.Header>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-1 ms-2">
                                                        ...
                                                        <Link scroll={false} href="#!" className="fs-11 text-muted">{idx.data1}</Link>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="btn-list">
                                                    <SpkTooltips placement="top" title="Edit">
                                                        <Link scroll={false} aria-label="anchor" href="#!" className="btn btn-icon btn-sm rounded-pill btn-info-light">
                                                    ...
                                                    <SpkTooltips placement="top" title="Delete">
                                                        <Link
                                                            ...
                                                            aria-label="anchor"
                                                            href="#!"
                                                            className="btn btn-icon btn-sm rounded-pill btn-primary2-light"
                                    ...
                                    {allData.map((idx) => (
                                        <tr key={Math.random()}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-1 flex-between pos-relative ms-2">
                                                        <div className="">
                                                            <Link scroll={false} href="#!" className="fs-13 fw-medium">{idx.emplyname}</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div className="g-2">
                                                    <SpkTooltips placement="top" title="Edit">
                                                        <Link href="#!" scroll={false} aria-label="anchor" className="btn  btn-primary-light btn-sm">
                                                            <span className="ri-pencil-line fs-14"></span>
                                                        </Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Delete">
                                                        <Link href="#!" onClick={() => handleRemove(idx.id)} scroll={false} aria-label="anchor" className="btn btn-danger-light btn-sm ms-2">
