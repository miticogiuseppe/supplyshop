...
import SpkCard1Component from "../../../../../shared/@spk-reusable-components/reusable-dashboards/spk-card1";
import SpkAnalyticsActive from "../../../../../shared/@spk-reusable-components/reusable-dashboards/spk-analyticsactive";
                        ...
                        <Card.Body className="p-4">
                            <div className="row justify-content-between">
                                <Col xxl={8} xl={4} lg={5} md={5} sm={5} className="">
                                    ...
                                    <Link href="#!" scroll={false} className="fw-medium text-fixed-white text-decoration-underline">Upgrade Now<i className="ti ti-arrow-narrow-right"></i></Link>
                                </Col>
