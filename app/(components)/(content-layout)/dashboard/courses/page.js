...
import { Coursedata, CourseSwiper, Courselist, Coursetop, Earningsoptions, Earningsseries, Professordata, UpcomingTasks } from "../../../../../shared/data/dashboard/coursesdata";
import dynamic from "next/dynamic";
import SpkCoursecardcomponent from "../../../../../shared/@spk-reusable-components/reusable-dashboards/spk-cousecard";
                            ...
                            <SpkListgroup as="ul" CustomClass="d-flex flex-column">
                                {Coursetop.map((idx) => (
                                    <ListGroup.Item as="li" key={Math.random()} className={`p-0 ${idx.class} border-0 text-default`}>
                                        <Link scroll={false} href="#!" className="w-100">
                            ...
                            <ul className="d-flex flex-column list-unstyled mb-0 popular-course">
                                <li className="text-muted mb-3">
                                    <div className="d-sm-flex align-items-start w-100">
                                        <Link scroll={false} href="#!" className="pe-4 inline-block">
                                        ...
                                        <div className="flex-grow-1 fw-medium">
                                            <div className="d-flex align-items-center" title="Instructor">
                                                <Link scroll={false} href="#!" className="pe-2">
                                                    <img src="../../assets/images/faces/1.jpg" alt="img" className="avatar avatar-xs rounded-pill" />
                                                </Link>
                                                <Link scroll={false} href="#!" className="flex-grow-1 text-default op-8">Natasha
                                                    Sil</Link>
                                                <Link scroll={false} href="#!" className=" d-block mb-1 fw-normal badge bg-primary3-transparent" title="Category"><i className="ri-price-tag-3-line "></i> UI/UX</Link>
                                            </div>
                                            <Link scroll={false} href="#!" className=" d-block mb-2 fw-medium">
                                ...
                                <li className=" text-muted mb-3">
                                    <div className="d-sm-flex align-items-start w-100">
                                        ...
                                        <div className="flex-grow-1 fw-medium">
                                            <div className="d-flex align-items-center" title="Instructor">
                                                <Link scroll={false} href="#!" className="pe-2">
                                                    <img src="../../assets/images/faces/6.jpg" alt="img" className="avatar avatar-xs rounded-pill" />
                                                </Link>
                                                <Link scroll={false} href="#!" className="flex-grow-1 text-default op-8">Catalina Keira
                                                </Link>
                                                <Link scroll={false} href="#!" className=" d-block mb-1 fw-normal badge bg-primary2-transparent" title="Category"><i className="ri-price-tag-3-line "></i> Marketing</Link>
                                            </div>
                                            <Link scroll={false} href="#!" className=" d-block mb-2 fw-medium">
                                ...
                                <li className=" text-muted mb-1">
                                    <div className="d-sm-flex align-items-start w-100">
                                        ...
                                        <div className="flex-grow-1 fw-medium">
                                            <div className="d-flex align-items-center" title="Instructor">
                                                <Link scroll={false} href="#!" className="pe-2">
                                                    <img src="../../assets/images/faces/11.jpg" alt="img" className="avatar avatar-xs rounded-pill" />
                                                </Link>
                                                <Link scroll={false} href="#!" className="flex-grow-1 text-default op-8">Telsko
                                                    William</Link>
                                                <Link scroll={false} href="#!" className=" d-block mb-1 fw-normal badge bg-primary1-transparent" title="Category"><i className="ri-price-tag-3-line "></i> Python</Link>
                                            </div>
                                            <Link scroll={false} href="#!" className=" d-block mb-2 fw-medium">
                                            ...
                                            <td>
                                                <div className="btn-list mb-0">
                                                    <SpkTooltips placement="top" title="View">
                                                        <Link scroll={false} href="#!" className="btn  btn-sm rounded-pill btn-primary-light mb-0"><i className="ti ti-eye"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Edit">
                                                        <Link scroll={false} href="#!" className="btn  btn-sm rounded-pill btn-secondary-light mb-0"><i className="ti ti-pencil"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Delete">
                                                        <Link scroll={false} href="#!" className="btn  btn-sm rounded-pill  btn-danger-light mb-0"><i className="ti ti-trash"></i></Link>
                                                    </SpkTooltips>
                                                </div>
                                            </td>
                                        </tr>
