...
import { Ecommercecard, Newlydata, Orderoptions, Orderseries, Payment, Recentactivity, Reportoptions, Reportseries, TopSellingdata, Visitoroptions, Visitorseries, tableData } from '../../../../../shared/data/dashboard/ecommercedata'
                    ...
                    <Row>
                        <Col xl={3}>
                            {Ecommercecard.map((idx) => (
                                <Spkcardscomponent key={Math.random()} svgIcon={idx.svgIcon} cardClass='overflow-hidden main-content-card' headingClass='d-block mb-1' mainClass='d-flex align-items-start justify-content-between' card={idx} badgeClass="md" dataClass="mb-0" />
                            ))}
                        </Col>
                        <Col xl={9}>
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <div className="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <Link scroll={false} href="#!" className="fs-14 fw-medium">
                                                                    {row.name}
                                                                </Link>
                                                            </div>
                                                        </div>
                    ...
                    <div className="card custom-card offer-card">
                        <div className="card-body p-3 pe-0">
                            <div className="d-flex align-items-end">
                                <div className="offer-card-details">
                                    <div className="offer-item">
                                        <div className="avatar avatar-xl mb-3">
                                            <img src="../../assets/images/ecommerce/png/17.png" alt="Product Image" className="img-fluid" />
                                        </div>
                                ...
                                <img src="../../assets/images/media/media-90.png" alt="Product Image" className="img-fluid offer-item-img ms-auto" />
                            </div>
                        </div>
                    </div>
                    <div className="card custom-card">
                                            ...
                                            <td>
                                                <div className="btn-list">
                                                    <SpkTooltips placement='top' title="View">
                                                        <Link aria-label="anchor" href="#!" scroll={false} className="btn  btn-icon btn-secondary-light"><i className="ti ti-eye"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement='top' title="Edit">
                                                        <Link aria-label="anchor" href="#!" scroll={false} className="btn  btn-icon btn-info-light"><i className="ti ti-pencil"></i></Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement='top' title="Delete">
                                                        <Link aria-label="anchor" href="#!" scroll={false} className="btn  btn-icon  btn-primary2-light"><i className="ti ti-trash"></i></Link>
                                                    </SpkTooltips>
                                                </div>
                                            </td>
                                        </tr>
