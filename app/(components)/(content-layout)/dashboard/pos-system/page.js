...
import { Orderlist, PosrSystemdata, TopSellingItems } from "../../../../../shared/data/dashboard/possystemdata";
                                ...
                                <Nav.Item>
                                    <Nav.Link as="div" eventKey="sec" onClick={() => handleTabClick('tab2')}>
                                        <Card className={`custom-card ${activeTab === 'tab2' ? 'active' : ''}`}>
                                            <Card.Body className="p-3">
                                                <Link scroll={false} href="#!" className="stretched-link categories" data-filter=".pizza">
                                                    <div className="d-flex gap-2 categories-content">
                                ...
                                <Nav.Item>
                                    <Nav.Link as="div" eventKey="thrd" onClick={() => handleTabClick('tab3')}>
                                        <Card className={`custom-card ${activeTab === 'tab3' ? 'active' : ''}`}>
                                            <Card.Body className="p-3">
                                                <Link scroll={false} href="#!" className="stretched-link categories" data-filter=".burger">
                                                    <div className="d-flex gap-2 categories-content">
                                                        <span className="avatar avatar-md menu-icon">
                                ...
                                <Nav.Item>
                                    <Nav.Link as="div" eventKey="frth" onClick={() => handleTabClick('tab4')}>
                                        <Card className={`custom-card ${activeTab === 'tab4' ? 'active' : ''}`}>
                                            <Card.Body className="p-3">
                                                <Link scroll={false} href="#!" className="stretched-link categories" data-filter=".waffle">
                                                    <div className="d-flex gap-2 categories-content">
                                                        <span className="avatar avatar-md menu-icon">
                                ...
                                <Nav.Item>
                                    <Nav.Link as="div" eventKey="fifth" onClick={() => handleTabClick('tab5')}>
                                        <Card className={`custom-card ${activeTab === 'tab5' ? 'active' : ''}`}>
                                            <Card.Body className="p-3">
                                                <Link scroll={false} href="#!" className="stretched-link categories" data-filter=".icecream">
                                                    <div className="d-flex gap-2 categories-content">
                                                        <span className="avatar avatar-md menu-icon">
                                ...
                                <Nav.Item>
                                    <Nav.Link as="div" eventKey="sixth" onClick={() => handleTabClick('tab6')}>
                                        <Card className={`custom-card ${activeTab === 'tab6' ? 'active' : ''}`}>
                                            <Card.Body className="p-3">
                                                <Link scroll={false} href="#!" className="stretched-link categories" data-filter=".coffee">
                                                    <div className="d-flex gap-2 categories-content">
                                                        <span className="avatar avatar-md menu-icon">
                                ...
                                <Nav.Item>
                                    <Nav.Link as="div" eventKey="seventh" onClick={() => handleTabClick('tab7')}>
                                        <Card className={`custom-card ${activeTab === 'tab7' ? 'active' : ''}`}>
                                            <Card.Body className="p-3">
                                                <Link scroll={false} href="#!" className="stretched-link categories" data-filter=".cupcakes">
                                                    <div className="d-flex gap-2 categories-content">
                                                        <span className="avatar avatar-md menu-icon">
                        ...
                        <Row>
                            <Col xl={12}>
                                <div className="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <Link scroll={false} href="#viewcart" className="btn btn-primary" onClick={handleShow} data-bs-toggle="offcanvas" aria-controls="viewcart"> View Cart<i className="ti ti-arrow-narrow-right ms-1 d-inline-block"></i> </Link>
                                </div>
                    ...
                    <Col xxl={3}>
                        <Card className="custom-card active">
                            ...
                            <div className="card-footer border-top-0">
                                <Link scroll={false} href="#!" className="btn btn-primary-light d-grid">
                                    View All
                                </Link>
                            </div>
                        </Card>
                        <Card className="custom-card">
                            <div className="card-header justify-content-between align-items-center">
                                ...
                                <Link scroll={false} href="#!" className="btn btn-primary-light border d-flex align-items-center btn-sm">
                                    View All
                                </Link>
                            </div>
                        ...
                        <Card className="custom-card p-3">
                            <div className="text-center d-flex flex-row align-items-center flex-wrap bg-primary-transparent p-3 justify-content-between rounded gap-1">
                ...
                <Offcanvas.Body className="p-0">
                    ...
                    <div className="p-3">
                        ...
                        <div className="d-flex gap-3 mt-4">
                            <Link scroll={false} href="#!" className="btn btn-primary1-light btn-wave flex-fill waves-effect waves-light" onClick={handleClose}>Save For Later</Link>
                            <Link href="/apps/ecommerce/checkout" className="btn btn-primary btn-wave flex-fill waves-effect waves-light">Pay Now</Link>
                        </div>
                    </div>
                </Offcanvas.Body>
            </Offcanvas>
