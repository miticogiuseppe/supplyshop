            ...
            <Row>
                ...
                <Col xl={4}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div id="primary1-colored-slider"><Slider aria-label="Temperature" defaultValue={30} getAriaValueText={valuetext} style={{ color: "var(--primary-tint1-color)" }} className='' /></div>
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={4}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div id="primary2-colored-slider"><Slider
                                aria-label="Temperature" defaultValue={30} getAriaValueText={valuetext} style={{ color: "var(--primary-tint2-color))" }} className='' /></div>
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={4}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div id="primary3-colored-slider"><Slider aria-label="Temperature" defaultValue={30} getAriaValueText={valuetext} style={{ color: "var(--primary-tint3-color)" }} className='' /></div>
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={4}>
