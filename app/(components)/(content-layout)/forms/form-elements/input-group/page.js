			...
			<Row>
				<Col xl={12}>
					<Row>
							...
							<SpkDropdown toggleas="a" Togglevariant="" Navigate="#!" Customtoggleclass="btn btn btn-primary dropdown-toggle dropdown-toggle-split no-caret dropdown-toggle rounded-0"
							   ...
							   <input type="text" className="form-control" aria-label="Text input with segmented dropdown button"/>
								...
								<InputGroup>
									...
									<SpkButton Buttontype="button" Buttonvariant="primary" >Action</SpkButton>
									<SpkDropdown toggleas="a" Togglevariant="" Navigate="#!" Customtoggleclass="btn btn-primary dropdown-toggle dropdown-toggle-split no-caret" Toggletext="Toggle Dropdown"
						...
						<Col xl={12}>
							<ShowCode title="Warpping" customCardClass="custom-card" customCardBodyClass="" reactCode={inputgroup11}>
				...
				<Col xl={12}>
					<ShowCode title="Buttons with dropdowns" customCardClass="custom-card" customCardBodyClass="" reactCode={inputgroup4}>
						...
						<InputGroup className="mb-3">
							<Form.Control type="text" className="form-control"
								aria-label="Text input with dropdown button" />
							<SpkDropdown Togglevariant="" Customtoggleclass="btn btn-outline-primary dropdown-toggle" Toggletext="Dropdown">
								<Dropdown.Item href="#!">Action</Dropdown.Item>
								<Dropdown.Item href="#!">Another action</Dropdown.Item>
								<Dropdown.Item href="#!">Something else here</Dropdown.Item>
								<Dropdown.Divider>
						...
						<InputGroup className="flex-nowrap">
							<SpkDropdown Togglevariant="" Customtoggleclass="btn btn-primary-transparent dropdown-toggle" Toggletext="Dropdown">
								<Dropdown.Item href="#!">Action</Dropdown.Item>
								<Dropdown.Item href="#!">Another action</Dropdown.Item>
								<Dropdown.Item href="#!">Something else here</Dropdown.Item>
								<Dropdown.Divider>
