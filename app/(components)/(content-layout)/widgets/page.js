...
const Widgets = () => {
    return (
        <Fragment>
            ...
            <Row>
                <div className="col-xxl-4 col-12">
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div id="salerevenue1">
                                <Spkapexcharts chartOptions={Revenue1options} chartSeries={Revenue1series} type="line" width={"100%"} height={320} />
                            </div>
                        </Card.Body>
                    </Card>
                </div>
            ...
            <Row>
                <Col xxl={3} lg={6}>
                    <Spkwidgetcard4component mainClass="online" icon='check-circle-fill' tooltip='Verified User' Img='../assets/images/faces/9.jpg' name='Daniel David' role='Web Designer' description='Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudan accusant. ' btn1='Follow' btn='Message' />
                </Col>
                <Col xxl={3} lg={6}>
