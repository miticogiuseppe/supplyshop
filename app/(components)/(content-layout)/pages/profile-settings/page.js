                ...
                <Col xl={9}>
                    <Card className="custom-card">
                        <Tab.Container defaultActiveKey="account">
                            <Nav className="nav-tabs tab-style-8 scaleX rounded m-3 profile-settings-tab gap-2" id="myTab4" role="tablist">
                                <Nav.Item className=" me-1" role="presentation">
                                    <Nav.Link eventKey="account" className="px-4 bg-primary-transparent" id="account" data-bs-toggle="tab" data-bs-target="#account-pane" type="button" role="tab" aria-controls="account-pane" aria-selected="true">Account</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className=" me-1" role="presentation">
                                    <Nav.Link eventKey="notification" className="px-4 bg-primary-transparent" id="notification-tab" data-bs-toggle="tab" data-bs-target="#notification-tab-pane" type="button" role="tab" aria-controls="notification-tab-pane" aria-selected="false">Notification</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link eventKey="security" className="px-4 bg-primary-transparent" id="security-tab" data-bs-toggle="tab" data-bs-target="#security-tab-pane" type="button" role="tab" aria-controls="security-tab-pane" aria-selected="false" tabIndex={-1}>Security</Nav.Link>
                                </Nav.Item>
                            </Nav>
                                            ...
                                            <div className="d-flex align-items-start flex-wrap gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="btn-list mb-1">
                                                        ...
                                                        <SpkButton Buttonvariant="primary1-light" Size="sm"><i className="ri-delete-bin-line me-1"></i>Remove</SpkButton>
                                                    </div>
                        ...
                        <div className="card-footer border-top-0">
                            <div className="btn-list float-end">
                                <SpkButton Buttonvariant="primary2">Deactivate Account</SpkButton>
