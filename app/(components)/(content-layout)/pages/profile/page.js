                                        ...
                                        <Card.Body className=" border-bottom border-block-end-dashed p-0">
                                            <ul className="list-group list-group-flush">
                                                <li className="list-group-item pt-2 border-0">
                                                    <div><span className="fw-medium me-2 mx-1">Name :</span><span className="text-muted">Spencer Robin</span></div>
                                                </li>
                                                <li className="list-group-item pt-2 border-0">
                                                    <div><span className="fw-medium me-2 mx-1">Designation :</span><span className="text-muted">Software Development Manager</span></div>
                                                </li>
                                                <li className="list-group-item pt-2 border-0">
                                                    <div><span className="fw-medium me-2 mx-1">Email :</span><span className="text-muted">spencer.robin22@example.com</span></div>
                                                </li>
                                                <li className="list-group-item pt-2 border-0">
                                                    <div><span className="fw-medium me-2 mx-1">Phone :</span><span className="text-muted">+1 (222) 111 - 57840</span></div>
                                                </li>
                                                <li className="list-group-item pt-2 border-0">
                                                    <div><span className="fw-medium me-2 mx-1">Experience :</span><span className="text-muted">10 Years</span></div>
                                                </li>
                                                <li className="list-group-item pt-2 border-0">
                                                    <div><span className="fw-medium me-2 mx-1">Age :</span><span className="text-muted">28</span></div>
                                                </li>
                                            </ul>
                                        </Card.Body>
                                        <div className="p-3 pb-1 d-flex flex-wrap justify-content-between">
                                            ...
                                            <Link scroll={false} href="#!" className="fs-12 text-muted"> View All<i className="ti ti-arrow-narrow-right ms-1 d-inline-block"></i> </Link>
                                        </div>
                                                        ...
                                                        <ul className="list-group list-group-flush border rounded-3">
                                                            ...
                                                            <li className="list-group-item p-3">
                                                                ...
                                                                <div className="d-flex align-items-center gap-5 flex-wrap">
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-3 me-2">
                                                                        <div>
                                                                            <span className="avatar avatar-md bg-primary1"><i className="ri-twitter-x-line fs-16"></i></span>
                                                                        </div>
                                                                        <div>
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-3 me-2">
                                                                        <div>
                                                                            <span className="avatar avatar-md bg-primary2"><i className="ri-linkedin-line fs-16"></i></span>
                                                                        </div>
                                                                        <div>
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-3">
                                                                        <div>
                                                                            <span className="avatar avatar-md bg-primary3"><i className="ri-briefcase-line fs-16"></i></span>
                                                                        </div>
                                                                        <div>
...
Specializing in [Your Specialization/Area of Expertise], I strive to infuse innovation into every project I undertake. With a track record of [Key Achievements] and valuable experiences, I'm committed to continual growth and eagerly anticipate the opportunities that lie ahead."/>
                                                    ...
                                                    <Tab.Pane eventKey="timeline" className="" id="timeline-tab-pane" role="tabpanel"
                                                        ...
                                                        <ul className="list-unstyled profile-timeline">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div className="d-flex align-items-end justify-content-between gap-2 flex-wrap mt-2">
                                                                        ...
                                                                        <div className="btn-list text-end">
                                                                            ...
                                                                            <SpkButton Buttonvariant="primary1-light" Size="sm" Customclass="waves-effect waves-light"><i className="ri-thumb-up-line"></i> 2</SpkButton>
                                                                            <SpkButton Buttonvariant="primary2-light" Size="sm" Customclass="waves-effect waves-light"><i className="ri-heart-line"></i> 3</SpkButton>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <div>
                                                                    ...
                                                                    <div className="d-flex gap-2 flex-wrap mb-2">
                                                                        <p className="text-muted mb-0">
                                                                            <span className="text-default"><span className="text-primary1 fw-medium">Varun Sonu </span> asking for recommendations on places to visit in the vacation destination</span>.
                                                                        </p>
                                                            ...
                                                            <li>
                                                                <div>
                                                                    ...
                                                                    <div className="d-flex gap-2 flex-wrap mb-2">
                                                                        <p className="text-muted mb-0">
                                                                            <span className="text-default">On a trending news topic, offering their perspective and engaging with other group members' <span className="text-primary2 fw-medium text-decoration-underline">#viewpoints</span></span>.
                                                                        </p>
                                                            ...
                                                            <li>
                                                                <div>
                                                                    ...
                                                                    <div className="d-flex gap-2 flex-wrap mb-1">
                                                                        <p className="mb-1">
                                                                            <span className="fw-semibold text-primary2">Invitation</span> to a virtual networking event from a professional connection, expressing interest and RSVPing for attendance.
                                                                        </p>
                                                                    ...
                                                                    <div className="d-flex align-items-end justify-content-between gap-2 flex-wrap mt-2">
                                                                        ...
                                                                        <div className="btn-list text-end">
                                                                            <SpkButton Buttonvariant="primary-light" Size="sm" Customclass="waves-effect waves-light"><i className="ri-message-3-line"></i> 4</SpkButton>
                                                                            <SpkButton Buttonvariant="primary1-light" Size="sm" Customclass="waves-effect waves-light"><i className="ri-thumb-up-line"></i> 2</SpkButton>
                                                                            <SpkButton Buttonvariant="primary1-light" Size="sm" Customclass="waves-effect waves-light"><i className="ri-heart-line"></i> 3</SpkButton>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </li>
