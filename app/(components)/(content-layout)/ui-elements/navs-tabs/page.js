                                        ...
                                        <div className="table-responsive">
                                            <SpkTablescomponent tableClass="mb-0" header={[{ title: 'Product' }, { title: 'Name' }, { title: 'Category' }, { title: 'Price' }]} >
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm bg-primary-transparent">
                                                            <img src="../../assets/images/ecommerce/png/23.png" alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Wrist Watch</td>
                                                    <td>Gadgets</td>
                            ...
                            <Card.Body className="">
                                <Nav className=" nav-tabs mb-3 border-0" role="tablist">
                                    ...
                                    <SpkDropdown Customclass="nav-item" Customtoggleclass="nav-link" Togglevariant="" Toggletext="Company" Navigate="#!">
                                        ...
                                        <Link scroll={false} className="dropdown-item" href="#!">Something else here
                                        </Link>
                                        <Link scroll={false} href="#!" className="dropdown-item">
                            ...
                            <Card.Body className="">
                                <Nav className=" nav-pills mb-3" role="tablist">
                                    ...
                                    <SpkDropdown Customclass="nav-item" toggleas="a" Customtoggleclass="nav-link" Toggletext="Cart" Navigate="#!">
                                        ...
                                        <Link scroll={false} className="dropdown-item" href="#!">Save For Later
                                        </Link>
                                        <Link scroll={false} href="#!" className="dropdown-item">
                                            <hr className="dropdown-divider" />
                                        </Link>
                                        <Link scroll={false} href="#!" className="dropdown-item">Recently Viewed</Link>
                                    </SpkDropdown>
                                    <Nav.Item>
