...
import { reusabletoast1, reusabletoast10, reusabletoast2, reusabletoast3, reusabletoast4, reusabletoast5, reusabletoast6, reusabletoast7, reusabletoast8, reusabletoast9, toast1, toast10, toast2, toast3, toast4, toast5, toast6, toast7, toast8, toast9 } from "../../../../../shared/data/prism/ui-elements-prism";
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Basic example" customCardClass="custom-card" customCardBodyClass="" reactCode={toast1} reusableCode={reusabletoast1}>
                        <SpkToast show={show} onClose={toggleShow} title="Xintra" message="Hello, world! This is a toast message." timestamp="11 min ago" imgSrc="../../assets/images/brand-logos/toggle-logo.png" ToastHeader={true} toastClass="custom-toast" headerClass="text-default" imgClass="custom-img-class" autohide={false} />
                    </ShowCode>
                </Col>
                <Col xl={6}>
                    <ShowCode title="Live example" customCardClass="custom-card" customCardBodyClass="" reactCode={toast2} reusableCode={reusabletoast2}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            <SpkToast show={show1} onClose={() => setShow1(false)} title="Xintra" message="Hello, world! This is a toast message." timestamp="11 min ago" imgSrc="../../assets/images/brand-logos/toggle-logo.png" ToastHeader={true} toastClass="custom-toast" headerClass="text-default" imgClass="custom-img-class" autohide={false} />
                        </ToastContainer>
                    </ShowCode>
                ...
                <Col xl={6}>
                    <ShowCode title="Stacking" customCardClass="custom-card" customCardBodyClass="" reactCode={toast3} reusableCode={reusabletoast3}>
                        <ToastContainer className="toast-container position-static">
                            ...
                            <SpkToast show={show2} onClose={toggleShow2} ToastHeader={true} toastClass="fade show" headerClass="text-default" imgSrc="../../assets/images/brand-logos/toggle-logo.png" imgClass="me-2" title="Xintra" timestamp="jsut now" message={"See? Just like this."} />
                            <SpkToast show={show3} onClose={toggleShow3} ToastHeader={true} toastClass="fade show" headerClass="text-default" imgSrc="../../assets/images/brand-logos/toggle-logo.png" imgClass="me-2" title="Xintra" timestamp="2 seconds ago" message={" Heads up, toasts will stack automatically"} />
                ...
                <Col xl={12}>
                    <ShowCode title="Solid Background Toasts" customCardClass="custom-card" customCardBodyClass="" reactCode={toast5} reusableCode={reusabletoast5}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            ...
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary1" bodyClass="text-fixed-white" onClose={() => setShow72(false)} show={show72} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary1" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary2" bodyClass="text-fixed-white" onClose={() => setShow73(false)} show={show73} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary2" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary3" bodyClass="text-fixed-white" onClose={() => setShow74(false)} show={show74} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary3" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-secondary" bodyClass="text-fixed-white" onClose={() => setShow8(false)} show={show8} delay={3000} autohide={true} headerClass="text-fixed-white bg-secondary" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-warning" bodyClass="text-fixed-white" onClose={() => setShow9(false)} show={show9} delay={3000} autohide={true} headerClass="text-fixed-white bg-warning" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-info" bodyClass="text-fixed-white" onClose={() => setShow10(false)} show={show10} delay={3000} autohide={true} headerClass="text-fixed-white bg-info" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-success" bodyClass="text-fixed-white" onClose={() => setShow11(false)} show={show11} delay={3000} autohide={true} headerClass="text-fixed-white bg-success" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-danger" bodyClass="text-fixed-white" onClose={() => setShow12(false)} show={show12} delay={3000} autohide={true} headerClass="text-fixed-white bg-danger" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                        </ToastContainer>
                    </ShowCode>
                </Col>
                <Col xl={12}>
                    <ShowCode title="Color Variants Live" customCardClass="custom-card" customCardBodyClass="" reactCode={toast6} reusableCode={reusabletoast6}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            ...
                            <SpkToast ToastHeader={true} bg="primary1-transparent" toastClass="colored-toast" onClose={() => setShow132(false)} show={show132} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary1" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} bg="primary2-transparent" toastClass="colored-toast" onClose={() => setShow133(false)} show={show133} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary2" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} bg="primary3-transparent" toastClass="colored-toast" onClose={() => setShow134(false)} show={show134} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary3" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} bg="secondary-transparent" toastClass="colored-toast" onClose={() => setShow14(false)} show={show14} delay={3000} autohide={true} headerClass="text-fixed-white bg-secondary" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} bg="warning-transparent" toastClass="colored-toast" onClose={() => setShow15(false)} show={show15} delay={3000} autohide={true} headerClass="text-fixed-white bg-warning" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} bg="info-transparent" toastClass="colored-toast" onClose={() => setShow16(false)} show={show16} delay={3000} autohide={true} headerClass="text-fixed-white bg-info" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} bg="success-transparent" toastClass="colored-toast" onClose={() => setShow17(false)} show={show17} delay={3000} autohide={true} headerClass="text-fixed-white bg-success" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                            <SpkToast ToastHeader={true} bg="danger-transparent" toastClass="colored-toast" onClose={() => setShow18(false)} show={show18} delay={3000} autohide={true} headerClass="text-fixed-white bg-danger" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" message="Your,toast message here." title="Xintra" />
                        </ToastContainer>
                    </ShowCode>
                </Col>
                <Col xl={12}>
                    <ShowCode title="Translucent" customCardClass="custom-card" customCardBodyClass="" reactCode={toast7} reusableCode={reusabletoast7}>
                        <SpkToast ToastHeader={true} show={show19} onClose={toggleShow19} toastClass="show" headerClass="text-default" imgClass="me-2" imgSrc="../../assets/images/brand-logos/toggle-logo.png" title="Xintra" timestamp="11 mins ago" message="Hello, world! This is a toast message." />
                    </ShowCode>
                    ...
                    <ShowCode title="Aligning Toast Using Flexbox" customCardClass="custom-card" customCardBodyClass="" reactCode={toast9} reusableCode={reusabletoast9}>
                        <div className="bd-example bg-light bd-example-toasts d-flex p-0 px-3">
                            <div aria-live="polite" aria-atomic="true"
                                ...
                                <SpkToast ToastHeader={true} show={show22} onClose={toggleShow22} toastClass="fade show shadow-lg" headerClass="text-default" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-logo.png" title="Xintra" timestamp="11 mins ago" message="Hello, world! This is a toast message." />
                            </div>
                        </div>
                    </ShowCode>
                </Col>
                    ...
                    <ShowCode title="Toast Placements" customCardClass="custom-card" customCardBodyClass="" reactCode={toast10} reusableCode={reusabletoast10}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 start-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow23(false)} show={show23} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-0 start-50 translate-middle-x p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow24(false)} show={show24} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow25(false)} show={show25} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 start-0 translate-middle-y p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow26(false)} show={show26} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 start-50 translate-middle">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow27(false)} show={show27} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 end-0 translate-middle-y p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow28(false)} show={show28} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 start-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow29(false)} show={show29} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 start-50 translate-middle-x p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow30(false)} show={show30} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 end-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => setShow31(false)} show={show31} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="../../assets/images/brand-logos/toggle-white.png" title="Xintra" message="Your,toast message here." />
                        </ToastContainer>
                    </ShowCode>
                </Col>
            </Row>
