"use client"
import BasicCard from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/basic-card";
import Spkbgcards from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkbgcards";
import Spkborderedcards from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkborderedcards";
import SpkCollapsecard from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkcollapsecard";
import SpkDropdowncard from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkdropdowncard";
import Spkhorizontalcards from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkhorizontalcards";
import Spkimagecapcards from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkimagecapcards";
import Spkimageoverlaycard from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkimageoverlaycard";
import SpkListgroupcards from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spklistgroupcards";
import Spknavigationcards from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spknavigationcards";
import SpkProfilecard from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkprofilecard";
import Spkratingcard from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spkratingcard";
import SpkSocialiconcard from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spksocialiconcard";
import Spktitlecards from "../../../../../shared/@spk-reusable-components/reusable-uielements/cards/spktitlecards";
    ...
    return (
        <Fragment>
            ...
            <Row>
                ...
                <Col xxl={3} xl={6} lg={6} md={6} sm={12} className="">
                    <BasicCard titleClass="fw-medium" imgClass="card-img-top" imgSrc="../../assets/images/media/media-24.jpg" title="Card title" bodyText={(
                        <>
                ...
                <Col xxl={3} xl={6} lg={6} md={6} sm={12} className="">
                    ...
                    <Card className=" custom-card">
                        <Card.Body>
                            ...
                            <p className="card-text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration many variations
                                of passages of Lorem Ipsum available there are so many ways to solve but the majority.</p>
                        </Card.Body>
                        <Card.Footer>
                ...
                <Col xxl={3} xl={6} lg={6} md={6} sm={12} className="">
                    ...
                    <BasicCard imgClass="card-img-top" imgSrc="../../assets/images/media/media-23.jpg" bodyText={(
                        <>
                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </>
                    )}
                    ...
                    <BasicCard bodyText={(
                        <>
                            ...
                            <p className="">It is a long established fact that a reader will be distracted by the readable content.</p>
                            <Link scroll={false} href="#!" className="btn btn-primary1 me-1">Read More</Link>
                            <Link scroll={false} href="#!" className="btn btn-primary2 me-1">Get Details</Link>
                        </>
                    )}
                    />
                </Col>
            ...
            <Row>
                ...
                <Col xl={3}>
                    <BasicCard header="Featured" titleClass="fw-medium mb-2" cardClass="text-center" bodyText={(
                        <>
            ...
            <Row>
                <Col xl={4}>
                    <BasicCard imgSrc="../../assets/images/media/media-29.jpg" imgClass="card-img-top" bodyText={(
                        <>
                ...
                <Col xl={4}>
                    <BasicCard imgSrcB="../../assets/images/media/media-28.jpg" imgClassB="card-img-bottom" bodyText={(
                        <>
                            <h6 className="card-title fw-medium">Image caps are widely used in Blog's</h6>
                            <p className="card-text mb-3 text-muted">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings.</p>
                            <p className="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                ...
                <Col xl={4}>
                    ...
                    <BasicCard imgSrcB="../../assets/images/media/media-31.jpg" imgClassB="card-img rounded-0" header="Image caps are widely used in Blog's" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>" bodyText={(
                        <>
                ...
                <Col xl={4}>
                    <BasicCard imgSrcA="../../assets/images/media/media-32.jpg" imgClassA="card-img-top" header="Image caps are widely used in Blog's" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>" bodyText={(
                        <>
                            <p className="card-text mb-1 text-muted">This is a wider card with supporting text below
                                as
                                a natural lead-in to additional content. This content is a
                ...
                <Col xl={4}>
                    ...
                    <BasicCard imgSrcB="../../assets/images/media/media-30.jpg" imgClassB="card-img rounded-0" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>"
                        bodyText={(
                            <>
            ...
            <Row>
                ...
                <Col xl={4}>
                    <Spkhorizontalcards Navigate="#!" Imgposition="after" CardHeader={true} CardFooter={false} Imagesrc="../../assets/images/media/media-38.jpg" Imgclass="img-fluid rounded-end h-100 w-100"
            ...
            <Row>
                ...
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="primary1" Imgsrc="../../assets/images/faces/11.jpg" Title="Gatin Leo" Value="Finished by today" Textclass="fixed-white" Class="fixed-white" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="primary2" Imgsrc="../../assets/images/faces/11.jpg" Title="Gatin Leo" Value="Finished by today" Textclass="fixed-white" Class="fixed-white" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="primary3" Imgsrc="../../assets/images/faces/11.jpg" Title="Gatin Leo" Value="Finished by today" Textclass="fixed-white" Class="fixed-white" />
                </Col>
                <Col xl={3}>
            ...
            <Row>
                <Col xl={12}>
                    <div className="card-group">
                        <BasicCard imgSrcA="../../assets/images/media/media-40.jpg" imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
                        ...
                        />
                        <BasicCard imgSrcA="../../assets/images/media/media-41.jpg" imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
                        ...
                        />
                        <BasicCard imgSrcA="../../assets/images/media/media-42.jpg" imgClassA="card-img-top" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
            ...
            <Row>
                <Col xl={12}>
                    <div className="row row-cols-1 row-cols-md-4 g-4">
                        <div className="col">
                            <BasicCard imgSrcA="../../assets/images/media/media-43.jpg" imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <BasicCard imgSrcA="../../assets/images/media/media-44.jpg" imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <BasicCard imgSrcA="../../assets/images/media/media-45.jpg" imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <BasicCard imgSrcA="../../assets/images/media/media-46.jpg" imgClassA="card-img-top" bodyText={(
                                <>
            ...
            <Row>
                <div className="col-xxl-3 col-xl-12">
                    <BasicCard imgSrcA="../../assets/images/media/media-23.jpg" imgClassA="card-img-top" linkTag={true} titleClass="fw-medium mb-0" title="Forests are Awesome." />
                </div>
                ...
                <div className="col-xxl-3 col-xl-6">
                    <BasicCard linkTag={true} imgSrcA="../../assets/images/media/media-47.jpg" imgClassA="card-img-top" bodyText={(
                        <>
                            <h6 className="card-title fw-medium">Most tropical areas are suitable</h6>
                            <p className="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                        </>
