                    ...
                    <Row>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    <p><Link href="#!" className="pe-none" tabIndex={-1} aria-disabled="false"><code className="text-primary fw-medium me-2">This link</code></Link>
                                        can
                                        not be clicked.
                                    </p>
                                    <p><Link href="#!" className="pe-auto"><code className="text-primary fw-medium me-2">This link</code></Link> can be clicked (this is default
                                        behavior).
                                    </p>
                                    <p className="pe-none mb-0"><Link href="#!" tabIndex={-1} aria-disabled="false"><code>This link</code></Link>
                                        can
            ...
            <Row>
                ...
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <img className="bd-placeholder-img mw-100 card-img" src="../../assets/images/media/media-3.jpg" alt="..." />
