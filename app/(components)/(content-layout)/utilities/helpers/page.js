                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div className="d-flex justify-content-evenly flex-wrap">
                                ...
                                <Link href="#!" scroll={false} className="link-primary1 fw-semibold fs-15 p-1">Primary1</Link>
                                <Link href="#!" scroll={false} className="link-primary2 fw-semibold fs-15 p-1">Primary2</Link>
                                <Link href="#!" scroll={false} className="link-primary3 fw-semibold fs-15 p-1">Primary3</Link>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div className="d-flex gap-3 align-content-center flex-wrap">
                                ...
                                <p><Link href="#!" scroll={false} className="d-inline-flex focus-ring focus-ring-primary1 py-1 px-2 text-decoration-none border rounded-2">Primary1 focus</Link></p>
                                <p><Link href="#!" scroll={false} className="d-inline-flex focus-ring focus-ring-primary2 py-1 px-2 text-decoration-none border rounded-2">Primary2 focus</Link></p>
                                <p><Link href="#!" scroll={false} className="d-inline-flex focus-ring focus-ring-primary3 py-1 px-2 text-decoration-none border rounded-2">Primary3 focus</Link></p>
