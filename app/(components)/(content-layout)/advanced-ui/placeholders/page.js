"use client"
import { placeholder1, placeholder2, placeholder3, placeholder4 } from "../../../../../shared/data/prism/advanced-ui-prism";
				...
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="" aria-hidden="true">
						...
						<div className="card-body">
							...
							<Link scroll={false} href="#!" tabIndex={-1} className="btn btn-primary disabled placeholder col-6"></Link>
						</div>
					</Card>
				</Col>
			</Row>
