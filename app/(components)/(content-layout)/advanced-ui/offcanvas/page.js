...
import { offcanvas1, offcanvas2, offcanvas3, offcanvas4, offcanvas5 } from "../../../../../shared/data/prism/advanced-ui-prism";
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Static backdrop" customCardClass="custom-card" customCardBodyClass="" reactCode={offcanvas1}>
                        ...
                        <Offcanvas show={show2} onHide={handleClose2} backdrop="static" id="staticBackdrop" className="offcanvas offcanvas-start" tabIndex="-1" aria-labelledby="offcanvasExampleLabel">
                ...
                <Col xl={6}>
                    <ShowCode title="Body scrolling" customCardClass="custom-card" customCardBodyClass="" reactCode={offcanvas3}>
                        ...
                        <Offcanvas show={show1} onHide={handleClose1} className="offcanvas offcanvas-start" tabIndex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasExampleLabel">
                            <Offcanvas.Header className="offcanvas-header border-bottom border-block-end-dashed">
                                <h5 className="offcanvas-title" id="offcanvasExampleLabel">Notifications</h5>
                ...
                <Col xl={6}>
                    <ShowCode title="Body scrolling and backdrop" customCardClass="custom-card" customCardBodyClass="" reactCode={offcanvas4}>
                        <SpkButton Customclass="btn btn-primary" Buttontype="button" Buttontoggle="offcanvas" onClickfunc={handleShow3}
                            ...
                            backdrop</SpkButton>
                        <Offcanvas show={show3} onHide={handleClose3} backdrop={true} className="offcanvas offcanvas-start" tabIndex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasExampleLabel">
                            <Offcanvas.Header className="offcanvas-header border-bottom border-block-end-dashed">
                                <h5 className="offcanvas-title" id="offcanvasExampleLabel">Notifications</h5>
                ...
                <div className="col-xl-12">
                    <ShowCode title="Placement" customCardClass="custom-card" customCardBodyClass="" reactCode={offcanvas5}>
                        ...
                        <SpkButton Buttonvariant='primary' Customclass="m-1" Buttontype="button" Buttontoggle="offcanvas" onClickfunc={handleShowr}
                            ...
                            offcanvas</SpkButton>
                        <Offcanvas placement='end' show={showr} onHide={handleCloser} className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasRight" aria-labelledby="offcanvasExampleLabel">
                            <Offcanvas.Header className="offcanvas-header border-bottom border-block-end-dashed">
                                <h5 className="offcanvas-title" id="offcanvasExampleLabel">Notifications</h5>
