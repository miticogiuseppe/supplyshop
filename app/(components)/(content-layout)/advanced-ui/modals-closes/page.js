"use client"
import { modal1, modal10, modal11, modal12, modal13, modal14, modal15, modal2, modal3, modal4, modal5, modal6, modal7, modal8, modal9 } from "../../../../../shared/data/prism/advanced-ui-prism";
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Basic Modal" customCardClass="custom-card" customCardHeaderClass="" customCardBodyClass="" reactCode={modal1}>
						...
						<Modal show={show} onHide={handleClose} className="fade" id="exampleModal" aria-labelledby="exampleModalLabel" >
						...
						<Modal show={show3} onHide={handleClose3} centered className='popover-modal' id="exampleModalScrollable4" aria-labelledby="exampleModalScrollable4" data-bs-keyboard="false"
							...
							<Modal.Body>
								...
								<p className="mb-0">
									...
									and 
									<SpkTooltips placement="top" title="tooltip">
										<Link href="#!" scroll={false} className="text-primary ms-1" data-bs-toggle="tooltip" title="Tooltip"> that link </Link>
