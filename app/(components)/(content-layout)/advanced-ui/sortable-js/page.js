...
const Sortablejs = () => {
    ...
    const [list, setList] = useState(Drag);
    const [list1, setList1] = useState(Drag1);
    const [list2, setList2] = useState(Drag2);
    const [list3, setList3] = useState(Drag3);
    const [list4, setList4] = useState(Drag4);
    const [list5, setList5] = useState(Drag5);
    const [list6, setList6] = useState(Drag6);
    const [list7, setList7] = useState(Drag7);
    const [list8, setList8] = useState(Drag8);
    const [list9, setList9] = useState(Drag9);
    const [list10, setList10] = useState(Drag10);
    const [list11, setList11] = useState(Drag11);
