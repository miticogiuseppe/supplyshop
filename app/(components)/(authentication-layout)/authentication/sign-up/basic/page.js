                                ...
                                <div className="row gy-3">
                                    ...
                                    <Col xl={12}>
                                        ...
                                        <div className="form-check mt-3">
                                            ...
                                            <Link scroll={false} href="/pages/terms-conditions" className="text-success">&nbsp;<u> Terms & Conditions </u>&nbsp;</Link> and <a className="text-success"><u>Privacy Policy</u></a>
                                        </div>
                                    </Col>
                                </div>
                                <div className="d-grid mt-4">
                                    <Link scroll={false} className="btn btn-primary" href="/dashboard/sales">Create Account</Link>
                                </div>
