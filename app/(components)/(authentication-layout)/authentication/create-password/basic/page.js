                            ...
                            <Card.Body className="p-5">
                                <div className="mb-3 d-flex justify-content-center">
                                    <Link href="/dashboard/sales">
                                        <img alt="logo" className="desktop-logo" src="../../../assets/images/brand-logos/desktop-logo.png" />
                                        <img alt="logo" className="desktop-white" src="../../../assets/images/brand-logos/desktop-white.png" />
                                    </Link>
                                </div>
                                ...
                                <div className="text-center">
                                    <p className="text-muted mt-3 mb-0">Back to home ? <Link scroll={false} className="text-primary" href={"/dashboard/sales"}>Click Here</Link></p>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
