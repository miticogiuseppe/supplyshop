...
export const Wishlistdata = [
  { id: 1, src: "../../assets/images/media/apps/apple.png", color: "primary1", head: "Apple", subhead: "AAPL", chart: Wishlistoptions({ color: 'rgb(227, 84, 212)' }), series: Tablesries, price: "150.20", percent: "+1.50", color1: "success" },
  { id: 2, src: "../../assets/images/media/apps/google.png", color: "primary2", head: "Google", subhead: "GOOG", chart: Wishlistoptions({ color: 'rgba(255, 93, 159, 1)' }), series: Tablesries, price: "2,500.5", percent: "-5.25", color1: "danger" },
  { id: 3, src: "../../assets/images/media/apps/microsoft.png", color: "primary3", head: "Microsoft", subhead: "MSFT", chart: Wishlistoptions({ color: 'rgba(14, 165, 232, 1)' }), series: Tablesries, price: "300.75", percent: "+2.30", color1: "success" },
  { id: 4, src: "../../assets/images/media/apps/amazon.png", color: "secondary", head: "Amazon", subhead: "AMZN", chart: Wishlistoptions({ color: 'rgba(255, 198, 8, 1)' }), series: Tablesries, price: "3,000.00", percent: "-10.50", color1: "danger" },
  { id: 5, src: "../../assets/images/media/apps/tesla.png", color: "warning", head: "Tesla", subhead: "TSLA", chart: Wishlistoptions({ color: 'rgba(158, 92, 247, 1)' }), series: Tablesries, price: "700.80", percent: "+8.00", color1: "success" },
  { id: 6, src: "../../assets/images/media/apps/facebook.png", color: "info", head: "Facebook", subhead: "FB", chart: Wishlistoptions({ color: 'rgb(227, 84, 212)' }), series: Tablesries, price: "350.40", percent: "-3.20", color1: "danger" },
  { id: 7, src: "../../assets/images/media/apps/nvidia.png", color: "success", head: "Nvidia", subhead: "NVDA", chart: Wishlistoptions({ color: 'rgba(33, 206, 158, 1)' }), series: Tablesries, price: "800.60", percent: "+5.75", color1: "success" },
]
...
const src1 = <img src="../../assets/images/media/apps/apple.png" alt="" className="invert-1" />
const src2 = <img src="../../assets/images/media/apps/google.png" alt="" className="invert-1" />
const src3 = <img src="../../assets/images/media/apps/tesla.png" alt="" className="invert-1" />
const src4 = <img src="../../assets/images/media/apps/microsoft.png" alt="" className="invert-1" />
