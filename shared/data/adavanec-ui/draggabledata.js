		...
		<Fragment>
			...
			<div className="row">
				...
				<Col xl={6} ref={rightContainerRef} id="draggable-right">
					...
					<Spkbgcards Navigate="#!" color="primary2" Imgsrc="../../assets/images/faces/5.jpg" Title="Sonia Agarwal" Value="In leave for 1 month" Textclass="fixed-white" Class="fixed-white" />
