                        ...
                        {card.features.map((item, index) => (
                            <li key={index}>
                                <div className="d-flex align-items-center">
                                    ...
                                    {item.icon === true ? <SpkTooltips className={`bg-${item.iconclass} p-1 lh-1 rounded-pill`} data-bs-toggle="tooltip" title="Provide essential insights and data analysis to help you track the performance.">
